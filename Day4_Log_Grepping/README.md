...
## NOTE
- This was done on a practical machine to help visualize and understanding today's activity. Therefore only the local-host attempted logins but could bring out different ports and it's number of counts. As you can see in the screenshot, the port is only given and the number of times it attempted logins
